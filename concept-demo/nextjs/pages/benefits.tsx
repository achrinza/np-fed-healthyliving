	...
	return (
		<>
			<Head>
                ...
                <script defer src="/static/js/survey.js" />
			...
			<div className="block-hero-wrapper">
                <Hero src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" style="position: relative; height: 100vh;">
                    <div className="block-hero__backdrop" />
                    <div className="block-hero__textblock">
                        <div className="block-hero__textblock-group">
                            <h1 className="block-hero__title">Stay healthy</h1>
                            <p className="block-hero__desc">Why should we stay healthy?</p>
                        </div>
                    </div>
                </Hero>
