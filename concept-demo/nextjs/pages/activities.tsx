    ...
    return (
        <>
            ...
            <div className="block-hero-wrapper">
                <Hero src="/static/media/activities-header.jpg" style="position: relative; height: 100vh;">
                    <div className="block-hero__backdrop" />
                    <div className="block-hero__textblock">
                        <div className="block-hero__textblock-group">
                            <h1 className="block-hero__title">Activities</h1>
                            <p className="block-hero__desc">Healthy Body, Healthy Mind</p>
                        </div>
                    </div>
                </Hero>

                <div className="block-hero-transitioner-wrapper">
                <svg xmlns="http://www.w3.org/2000/svg" height="320px" width="100%" preserveAspectRatio="none" viewBox="0 0 1440 320">
                    <path fill="#0099ff" fill-opacity="1" d="M0,128L48,117.3C96,107,192,85,288,80C384,75,480,85,576,106.7C672,128,768,160,864,192C960,224,1056,256,1152,266.7C1248,277,1344,267,1392,261.3L1440,256L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
                </svg>
                ...
                <div>
                    <form className="response">
                        <div className="mx-auto w-50">
                            ...
                            <br/>
                            <p className="output" id="result"></p>
                        </div>
                    </form>
                </div>
            </div>
